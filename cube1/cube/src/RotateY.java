...
public class RotateY extends JTextField implements Observer {
    //JTextField smallField;
    private MyPanel panel;
    private Cube cube;

    public RotateY(MyPanel panel, Cube cube){
        this.panel = panel;
        this.cube = cube;
        // Создание текстовых полей
        new JTextField(15);
        setToolTipText("rotateY");
    ...
    private class MyButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            cube.rotate(0, Double.parseDouble(s), 0);
        }
    }
}
