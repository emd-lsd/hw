...
public class RotateX extends JTextField implements Observer {
    //JTextField smallField;
    private MyPanel panel;
    private Cube cube;

    public RotateX(MyPanel panel, Cube cube){
        this.panel = panel;
        this.cube = cube;
        // Создание текстовых полей
        new JTextField(15);
        setToolTipText("rotateX");
    ...
    private class MyButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            cube.rotate(Double.parseDouble(s), 0, 0);
        }
    }
}
