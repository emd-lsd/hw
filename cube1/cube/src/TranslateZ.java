...
public class TranslateZ extends JTextField implements Observer {
    //JTextField smallField;
    private MyPanel panel;
    private Cube cube;

    public TranslateZ(MyPanel panel, Cube cube){
        this.panel = panel;
        this.cube = cube;
        // Создание текстовых полей
        new JTextField(15);
        setToolTipText("translateZ");
    ...
    private class MyButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            cube.translate(0, 0, Double.parseDouble(s));
        }
    }
}
